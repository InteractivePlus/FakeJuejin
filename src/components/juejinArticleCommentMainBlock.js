...
const JuejinArticleCommentMainBlock = (props) => {
    //获取Props
    const { children, authorName, avatarSrc, content, like, commentCount } = props;
            ...
            <div className="flex">
                ...
                <div className="flex flex-col">
                    <div className="px-3 divide-x divide-gray-300 flex flex-row " style={{ fontSize: '14px' }}>
                        ...
                        <div className="px-3 text-juejinnav">前端攻城狮</div>
                        <div className="px-3 text-juejinnav">114514小时前</div>
                    </div>
                    <div className="p-3" style={{ fontSize: '14px', color: '#4e5969' }}>
                        {content}
                    </div>
...
export default JuejinArticleCommentMainBlock;